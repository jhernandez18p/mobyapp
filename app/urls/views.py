...
def page_not_found_view(request):
    ...
    template = 'auth/error/page_not_found_view.html'
    context = {}
...
def error_view(request):
    ...
    template = 'auth/error/error_view.html'
    context = {}
...
def permission_denied_view(request):
    ...
    template = 'auth/error/permission_denied_view.html'
    context = {}
...
def bad_request_view(request):
    ...
    template = 'auth/error/bad_request_view.html'
    context = {}
